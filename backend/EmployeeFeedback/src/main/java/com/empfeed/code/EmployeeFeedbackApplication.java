...
import com.empfeed.code.util.Constant;
...
public class EmployeeFeedbackApplication {
	...
	public GraphQLErrorHandler errorHandler() {
		GraphQLErrorHandler graphQLErrorHandler = new GraphQLErrorHandler() {
	...
	public CommandLineRunner demo(EmployeeRepository employeeRepository,
		...
		return (args) -> {
			...
			manager1.setUserType(Constant.UserType.MANAGER.value());
			...
			manager2.setUserType(Constant.UserType.MANAGER.value());
			...
			manager3.setUserType(Constant.UserType.MANAGER.value());
			...
			employee.setUserType(Constant.UserType.EMPLOYEE.value());
			...
			messageThread1.getMessages()
					.addAll(Arrays.asList(
							Message.builder().text("I have concerns about XYZ...")
									...
									.messageSender(Constant.MessageSender.EMPLOYEE.value()).messageThread(thread).build(),
							Message.builder().text("I can resolve your issues!").createdAt(new Date())
									.messageSender(Constant.MessageSender.MANAGER.value()).messageThread(thread).build()));
